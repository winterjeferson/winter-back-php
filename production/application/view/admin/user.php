<div class="col-es-12"><div class="container"><h1 class="page-title"> <?php echo $arrContent['head']['translation']['users']; ?> </h1><div class="row"><div class="col-es-12"><h2 class="page-title"> <?php echo $arrContent['head']['translation']['register']; ?> </h2></div><form class="row form form-grey" data-id="formRegister"><div class="col-es-4"><div class="form-field"><label><?php echo $arrContent['head']['translation']['email']; ?>:</label> <input type="text" value="" data-id="email"></div></div><div class="col-es-4"><div class="form-field"><label><?php echo $arrContent['head']['translation']['password']; ?>:</label> <input type="password" value="" placeholder="" data-id="password"></div></div><div class="col-es-4"><div class="form-field"><label><?php echo $arrContent['head']['translation']['permission']; ?>:</label> <select aria-label="select" data-id="permission"> <?php
                            $string = '';

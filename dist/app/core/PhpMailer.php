...
class PhpMailer {
     ...
     * @return bool
     */
    function SetLanguage($lang_type = 'br', $lang_path = 'language/') {
        if (!(@include $lang_path . 'phpmailer.lang-' . $lang_type . '.php')) {
            $PHPMAILER_LANG = array();
            $PHPMAILER_LANG["provide_address"] = 'Voce deve fornecer pelo menos um endereco de destinatario de email.';
            $PHPMAILER_LANG["mailer_not_supported"] = 'mailer nao suportado.';
            $PHPMAILER_LANG["execute"] = 'Nao foi possível executar: ';
            $PHPMAILER_LANG["instantiate"] = 'Nao foi possível instanciar a funcao mail.';
            $PHPMAILER_LANG["authenticate"] = 'Erro de SMTP: Não foi possivel autenticar.';
            $PHPMAILER_LANG["from_failed"] = 'Os enderecos de rementente a seguir falharam: ';
